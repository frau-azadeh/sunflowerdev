      ...
      >
        <div className="container mx-auto text-center ">
          ...
          <p className=" text-justify  lg:pl-20 lg:pr-20 md:pr-4 md:pl-4 pl-10 pr-10">
            من آزاده شریفی سلطانی هستم و یک علاقه مند به برنامه نویسی و زبان
            آلمانی . اگه بخوام خودم رو کمی معرفی کنم تحصیلاتم رو در مقطع کاردانی
            تو رشته نرم افزار کامپیوتر در دانشگاه جامع علمی کاربردی به اتمام
            رسوندم و کارشناسی رو در شهر سمنان در دانشگاه کومش ادامه دادم. بعد از
            اون رشته آموزش زبان آلمانی رو برای کارشناسی ارشد انتخاب کردم.
          </p>
