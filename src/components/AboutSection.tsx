      ...
      >
        <div className="container mx-auto text-center ">
          ...
          <p className=" text-justify  lg:pl-20 lg:pr-20 md:pr-4 md:pl-4 pl-10 pr-10">
            ...
            تحصیلاتم را در مقطع کاردانی در رشته‌ی نرم‌افزار کامپیوتر از دانشگاه
            جامع علمی‌کاربردی به پایان رساندم و دوره‌ی کارشناسی را در دانشگاه
            کومش سمنان ادامه دادم. پس از آن، با علاقه‌ به زبان و آموزش، رشته‌ی
            آموزش زبان آلمانی را برای مقطع کارشناسی ارشد انتخاب کردم. در حال
            حاضر در شرکت فولاد حامیران مشغول به کار هستم و پیش‌تر نیز در
            شرکت‌های نگین سبز خاورمیانه و پارس فعالیت داشته‌ام. در کنار مسیر
            شغلی‌ام، برای توسعه‌ی فردی و افزایش دانش مدیریتی، دوره‌ی MBA را در
            دانشگاه تهران به پایان رسانده‌ام.
          </p>
        </div>
      </section>
    </>
